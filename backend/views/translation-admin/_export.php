    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-flat btn-flat btn-default pull-left" data-dismiss="modal"><?= Yii::t('admin', 'Cancel') ?></button>
                <button type="submit" class="btn btn-flat btn-flat btn-primary anti-dc" form="export-form"><?= Yii::t('admin', 'Run') ?></button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
