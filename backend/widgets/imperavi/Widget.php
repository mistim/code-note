...
class Widget extends BaseWidget
{
    ...
    const INLINE_JS_KEY = 'backend/widgets/imperavi/';
    ...
    {
        if (!isset(Yii::$app->i18n->translations['app/widgets/imperavi']) && !isset(Yii::$app->i18n->translations['backend/widgets/imperavi/*'])) {
            Yii::$app->i18n->translations['backend/widgets/imperavi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@backend/widgets/imperavi/messages',
                'forceTranslation' => true,
                'fileMap' => [
                    'backend/widgets/imperavi' => 'imperavi.php'
                ]
            ];
        }
    }
