...
use backend\widgets\fileapi\Widget;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?= Yii::t('admin', 'MODAL_TITLE') ?></h4>
                </div>
                <div class="modal-body">
                    <div id="modal-preview"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?= Yii::t('admin', 'MODAL_CANCEL') ?></button>
                    <button type="button" class="btn btn-primary crop"><?= Yii::t('admin', 'MODAL_SAVE') ?></button>
                </div>
            </div>
        </div>
    </div>
